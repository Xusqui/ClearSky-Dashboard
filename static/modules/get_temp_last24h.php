...
if (isset($_GET['start']) && isset($_GET['end'])) {
    ...
    if ($start_dt && $end_dt) {
        ...
        $query = "
            SELECT DATE_FORMAT(`timestamp`, ?) AS hora, temperatura, sensacion_termica, punto_rocio
            FROM meteo
        ...
        $query = "
            SELECT DATE_FORMAT(`timestamp`, '%H:%i') AS hora, temperatura, sensacion_termica, punto_rocio
            FROM meteo
