...
if (isset($_GET['start']) && isset($_GET['end'])) {
    ...
    if ($start_dt && $end_dt) {
        ...
        $query = "
            SELECT DATE_FORMAT(`timestamp`, ?) AS hora, viento_velocidad, viento_racha, viento_direccion
            FROM meteo
        ...
        $query = "
            SELECT DATE_FORMAT(`timestamp`, '%H:%i') AS hora, viento_velocidad, viento_racha, viento_direccion
            FROM meteo
