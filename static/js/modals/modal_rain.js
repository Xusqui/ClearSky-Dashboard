...
document.addEventListener("DOMContentLoaded", function () {
    ...
    widget.onclick = function () {
        ...
        fetch("./static/modules/modals/get_rain_historic_data.php")
    ...
    function loadRainChart(startMonth, endMonth) {
        ...
        const fetchUrl = `./static/modules/modals/get_rain_monthly.php?start=${encodeURIComponent(startMonth)}&end=${encodeURIComponent(endMonth)}`;
