                    ...
                    <div class="max-width">
                        ...
                        <div id="seeingModal" class="modal">
                            <div class="modal-content">
                                <button class="close" aria-label="Cerrar" id="closeSeeingModal">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                                        <line x1="18" y1="6" x2="6" y2="18"></line>
                                        <line x1="6" y1="6" x2="18" y2="18"></line>
                                    </svg>
                                </button>
                                <div class="infografia">
                                    <h1-seeing>🌠 Datos del Seeing Astronómico</h1-seeing>
                                    <div class="bloque">
                                        <div class="card">
                                            <h2-seeing>🌡️ Variación térmica</h2-seeing>
                                            <p id="t8h">*5.20ºC (últimas 8h)</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>💧 Variación de humedad</h2-seeing>
                                            <p id="h8h">*22.0% (últimas 8h)</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌬️ Viento actual</h2-seeing>
                                            <p id="wnow">*6.00 Km/h</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌬️ Racha de viento actual</h2-seeing>
                                            <p id="gnow">*6.00 Km/h</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>📉 Variación de presión</h2-seeing>
                                            <p id="p8h">*2.70 hPa</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>☀️ Radiación solar</h2-seeing>
                                            <p id="rs">*9.800 W/m²</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌀 Temp. a 500 hPa</h2-seeing>
                                            <p id="t500">*-10.70ºC</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌀 Temp. a 300 hPa</h2-seeing>
                                            <p id="t300">*-37.00ºC</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>💨 Viento a 500 hPa</h2-seeing>
                                            <p id="w500">*44.60 km/h</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>💨 Viento a 300 hPa</h2-seeing>
                                            <p id="w300">*51.10 km/h</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌪️ Shear vertical</h2-seeing>
                                            <p id="shear">*6.50 (turbulencia)</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>📊 DeltaT</h2-seeing>
                                            <p id="deltaT">*26.30 (estabilidad)</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>☁️ Cobertura de nubes bajas</h2-seeing>
                                            <p id="clow">*0%</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌥️ Cobertura de nubes medias</h2-seeing>
                                            <p id="cmid">*0%</p>
                                        </div>
                                        <div class="card">
                                            <h2-seeing>🌤️ Cobertura de nubes altas</h2-seeing>
                                            <p id="chigh">*0%</p>
                                        </div>
                                    </div>

                                    <div class="footer">
                                        👁️ Seeing: <strong><span id="seeingtext">*Bueno</span></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="pws-info-dialog" class="modal">
                            <div class="modal-content">
                                ...
                                <h2>Estación Meteorológica / Observatorio: <?php echo $observatorio; ?></h2>
                                <ul>
                                    <li class="spacer"><span class="label">Nombre:</span><span><?php echo $observatorio; ?></span></li>
                                    <li><span class="label">Latitud:</span><span><?php echo $latitud; ?></span></li>
                                    <li><span class="label">Longitud:</span><span><?php echo $longitud; ?></span></li>
                                    <li class="spacer"><span class="label">Elevación:</span><span><?php echo $elev; ?> m</span></li>
                                    <li><span class="label">Ciudad:</span><span><?php echo $city; ?></span></li>
                                    <li class="spacer"><span class="label">País:</span><span><?php echo $country; ?></span></li>
                                    <li><span class="label">Hardware:</span><span><?php echo $hardware; ?></span></li>
                                    <li><span class="label">Software:</span><span><?php echo $software; ?></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
