...
- [Guía de Configuración](#-guía-de-configuración)
  ...
  - [Paso 5: Modificar archivos de configuración](#5️⃣-paso-5-archivos-de-configuración)
  - [Paso 6: Crear el Token para que Home Assistant se autentique en la web](#6️⃣-paso-6-crear-el-token-para-que-home-assistant-se-autentique-en-la-web)
  - [Paso 7: Crear Automatización en Home Assistant](#7️⃣-paso-7-crear-automatización-en-home-assistant)
- [ToDo](#-todo)
- [Feedback](#-feedback)
